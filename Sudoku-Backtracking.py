...
class NewPuzzle:
    ...
    def __init__(self, screen, squares=None):
        ...
        self.original_board_values = {(col, row, self.return_block_number((col, row))): self.board[row][col] for row in range(
    ...
    def return_possible_numbers(self, queried_points=None, input_coord=(), val=None):
    ...
    def draw_false(self, square_to_update, key, show_step):
